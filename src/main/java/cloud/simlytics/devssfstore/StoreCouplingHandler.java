...
public class StoreCouplingHandler extends OutputCouplingHandler {
  ...
  public void handlePortValue(String sender, PortValue<?> portValue,
    ...
    if (sender.startsWith("clerk")) {
      ImmutableCustomer customer = ClerkModel.clerkOutputPort.getValue(portValue);
      PortValue<ImmutableCustomer> inputPortValue = StoreObserver.observerInputPort.createPortValue(
          customer);
      ...
      ImmutableCustomer customer = CustomerGenerator.generatorOutputPort.getValue(portValue);
      PortValue<ImmutableCustomer> inputPortValue = ClerkModel.clerkInputPort.createPortValue(customer);
