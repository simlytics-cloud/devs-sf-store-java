 ...
 * <p>
 * Key Points:
 * - The {@code toMutable()} method is responsible for creating a mutable instance from the immutable
 *   one.
 ...
 * <p>
 * Exceptions:
 * The {@code toMutable()} method throws a {@code RuntimeException} in cases where the transformation
 * process fails due to factors such as missing constructors, inaccessible fields, or class
 * mismatches.
 * <p>
 * Requirements:
